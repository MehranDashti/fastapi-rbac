...
async def signup(
    ...
    return created(UserDetailResponse.from_user(user, set()))
...
@router.post("/refresh", summary="Issue a new access token using a valid refresh token")
...
@router.patch("/profile", summary="Update the current user's profile")
